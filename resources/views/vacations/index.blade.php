                            ...
                            <div class="pr-1 mb-3 mb-xl-0">
                                <div class="d-flex">
                                    <h5 class="content-title mb-0 my-auto">{{ __('Dashboard') }}</h5><span
                                        class="text-muted mt-1 tx-13 ml-2 mb-0">/ {{ __('Vacations  ') }}  </span>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <table class="table text-md-nowrap dataTable no-footer"
                                                        ...
                                                        @foreach($vacations as $vacation)
                                                            <tr>
                                                                <td>
                                                                    <img src="{{ asset('spaces/' . $vacation->thumbnail) }}" class="w-75" alt="">
                                                                </td>
                                                                <td>
                                                                    <img src="{{ asset('qr_codes/' . $vacation->qrcode) }}" class="w-75" alt="">
                                                                </td>
                                                                <td>{{$vacation->name}}</td>
                                                                ...
                                                                <td>
														<span class="ml-auto">
															<a href="{{ route('admin.vacations.edit',['id'=>$vacation->id]) }}"><i
                                                            ...
                                                            @if ( $vacation->qrcode !== null )
                                                                <a href="{{ asset('qr_codes/' . $vacation->qrcode) }}" download>
                                                                    <i
														  ...
														  <div class="modal-dialog">
														    <div class="modal-content">
														      ...
														      <form id="delete_modal_form" method="GET"
                                                                    action="{{route('admin.vacations.delete', $vacation->id)}}">
														      	@csrf
