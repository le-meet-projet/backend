              ...
              @if(count($total) > 0)
                ...
                <div class="col-lg-12 card">
                    <div class="col-lg-6 month">
                        <h3><strong><i class="bi bi-file-earmark-text"></i>{{ $v_total->Months}}</strong></h3>
                    </div>
    ...
    <nav class ="navbar navb  bg-light">
        <div class="container">
            <ul class="nav navbar-nav">
                ...
                <li><a href="{{ route('merchant.whallet')}}" class="active"><i class="bi bi-wallet-fill" ></i><br><strong>المحفضة</strong>  </a> </li>
