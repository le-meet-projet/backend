    ...
    <div class="container">
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <!-- /row -->
                <!-- row -->
                <form method="POST" action="{{route('admin.tables.update', ['id' => $content->id])}}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pd-30 pd-sm-40 bg-gray-200">
                                        ...
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                <img src="/tables/{{$content->thumbnail}}" class="   " width="70px">
                                                <input class="form-control" name="thumbnail" type="file"
                                                       value="{{ $content->thumbnail }}" @if($content->thumbnail === null) required @endif>
                                            </div>
                                        </div>
                                        <div class="row row-xs align-items-center mg-b-20">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                @if(is_array(json_decode($content->gallery, true))&& $content->gallery !== null)
                                                    @foreach(json_decode($content->gallery, true) as $image)
                                                        <img src="{{ asset('tables/' . $image) }}" class="" width="70px"
                                                             alt="">
                                                    @endforeach
                                                @endif
                                                <input type="file" class="form-control" name="images[]"
                                                       placeholder="address" multiple @if($content->gallery === null) required @endif>
                                            </div>
                                        </div>
                                        <div class="row row-xs align-items-center mg-b-20">
                                            <div class="col-md-4">
