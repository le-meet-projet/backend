    ...
    <div class="container">
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <!-- /row -->
                <!-- row -->
                <form enctype="multipart/form-data" id="user_form" method='post'
                      action="{{ route('admin.users.update',['id'=>$content->id]) }}">
                    @csrf
                    <div class="row">
                            ...
                            <div class="card">
                                        ...
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                <input required="" class="form-control"
                                                       placeholder="{{ __('User Name') }} " name="name" type="text"
                                                       value="{{ $content->name }}">
                                            </div>
                                        </div>
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                <input required="" class="form-control " name="email"
                                                       placeholder=" {{ __('User Email') }}" type="mail"
                                                       value="{{ $content->email }}">
                                            </div>
                                        </div>
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                <input required="" class="form-control" name="phone"
                                                       placeholder=" {{ __('User Phone Number') }}" type="number"
                                                       value="{{ $content->phone }}">
                                            </div>
                                        </div>
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                <input class="form-control" name="address"
                                                       ...
                                                       value="{{ $content->address }}" required>
                                            </div>
                                        </div>
                                        <div class="row row-xs align-items-center mg-b-20">
                                            <div class="col-md-4">
                                        ...
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                                <select name="status" id="input-statue" class="form-control">
                                                    <option
                                                        value="{{ $content->status }}">{{ $content->status }} </option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pd-30 pd-sm-40 bg-gray-200">
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="password"
                                                       name="password"
                                                       placeholder="{{ __('Enter here the new password') }}"/>
                                                <div class="input-group-btn">
                                                    <button type="button" onclick="tooglePassword()"
                                                            class="btn btn-default"><i id="eye" class="icon-eye"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <a onclick="password_generator()"
                                               class="btn btn-primary">{{ __('create strong password') }}</a>
                                        </div>
                                    </div>
                                    <button
