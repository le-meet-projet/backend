...
<div class="container">
			<div class="main-content horizontal-content">
				...
				<div class="container">
					...
					<!-- /row -->
					<!-- row -->
					<form method="POST" action="{{route('admin.spaces.update',['id'=>$content->id])}}"  enctype="multipart/form-data">
											@csrf
					<div class="row">
								       ...
								       <div class="row row-xs align-items-center mg-b-20">
										...
										<div class="row row-xs align-items-center mg-b-20">
											...
											<div class="col-md-8 mg-t-5 mg-md-t-0">
												...
												<input  class="form-control" name="thumbnail"   type="file" value="{{ $content->thumbnail }}"required>
											</div>
										</div>
										<div class="row row-xs align-items-center mg-b-20">
											<div class="col-md-4">
