                            ...
                            <div class="pr-1 mb-3 mb-xl-0">
                                <div class="d-flex">
                                    <h5 class="content-title mb-0 my-auto">{{ __('Dashboard') }}</h5><span
                                        class="text-muted mt-1 tx-13 ml-2 mb-0">/ {{ __('Meeting Spaces') }}  </span>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <table class="table text-md-nowrap dataTable no-footer"
                                                        ...
                                                        @foreach($meetings as $meeting)
                                                            <tr>
                                                                <td>
                                                                    <img
                                                                        src="{{ asset('spaces/' . $meeting->thumbnail) }}"
                                                                        class="w-75" alt="">
                                                                </td>
                                                                <td>
                                                                    <img
                                                                        src="{{ asset('qr_codes/' . $meeting->qrcode) }}"
                                                                        alt="" class="w-75">
                                                                </td>
                                                                <td>{{$meeting->name}}</td>
                                                                ...
                                                                <td>
														<span class="ml-auto">
															<a href="{{ route('admin.spaces.edit',['id'=>$meeting->id]) }}"><i
                                                            ...
                                                            @if($meeting->qrcode !== null)
                                                                <a href="{{ asset('qr_codes/' . $meeting->qrcode) }}" download>
														  ...
														  <div class="modal-dialog">
														    <div class="modal-content">
														      ...
														      <form id="delete_modal_form" method="GET"
                                                                    action="{{route('admin.spaces.delete', $meeting->id)}}">
														      	@csrf
