...
<div class="main-content horizontal-content">
	...
	<div class="container">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex my-xl-auto right-content">						
								<div class="pr-1 mb-3 mb-xl-0">
									<a href="{{ route('home.') }}"><button type="button" class="btn btn-danger btn-icon mr-2"><i class="mdi mdi-arrow-left"></i></button></a>
								</div>	
								<div class="pr-1 mb-3 mb-xl-0">
								   <div class="d-flex">
						...
						<div class="d-flex my-xl-auto right-content">						
							<div class="pr-1 mb-3 mb-xl-0">
								<a href="{{ route('home.orders.index') }}"><button type="button" class="btn btn-warning  btn-icon mr-2"><i class="mdi mdi-refresh"></i></button></a>
							</div>					 
						</div>
					</div>
					<!-- breadcrumb -->
										...
										<div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
											...
											<tbody>
												<tr>
													...
													<td>15%</td>
													<td>type</td>
													<td><a href=" {{ route('home.orders.details') }}">{{ __('details') }}</a></td>
												</tr>
												<tr>
													<td>15</td>
													<td>25/10/2019</td>
